...
SLOT="0"
IUSE="audit -box-env build caps +cramfs cryptsetup fdformat +hardlink kill +logger magic ncurses nls pam python +readline rtas selinux slang static-libs +su +suid systemd test tty-helpers udev unicode uuidd"
...
multilib_src_configure() {
	...
	if ! use box-env && multilib_is_native_abi; then
		myeconfargs+=(
			--disable-chfn-chsh
			--disable-login
			--disable-newgrp
